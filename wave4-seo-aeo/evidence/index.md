...
- Prefer Markdown: send `Accept: text/markdown` or fetch this page at [index.md](https://grokdex.net/index.md).
- Site map for models: [llms.txt](https://grokdex.net/llms.txt), full text [llms-full.txt](https://grokdex.net/llms-full.txt).
- Public JSON: [GET /api/bots](https://grokdex.net/api/bots). List a live share URL with POST.
- MCP: [server card](https://grokdex.net/.well-known/mcp/server-card.json) · endpoint [ /mcp ](https://grokdex.net/mcp). Tools `list_bot` (publish or update) and `refresh_bot`.

## How to use it

1. [Browse the board](https://grokdex.net/templates/index.md).
2. [Open the catalog](https://grokdex.net/catalog/index.md) — same listings as a parade.
3. Open a listing, preview on x.ai, then Add.
4. [Share a bot](https://grokdex.net/upload/index.md) — free, no account.

## Ranked listings

- [Writer](https://grokdex.net/templates/writer-n92u9t/index.md) — Drafts posts, emails, and short copy in your voice. Short and direct. Never sends without your yes.
- [Research](https://grokdex.net/templates/research-q6nive/index.md) — Primary-source research for anyone who needs cited answers. Separates facts from interpretation and reports to a chief of agents.
